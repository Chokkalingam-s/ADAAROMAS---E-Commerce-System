...
<div class="container-fluid p-3">
  ...
  <div class="row g-2 mb-3">
    <div class="col-6 col-md-3"><div class="metric-box"><h5>Stock in Hand</h5><h4 id="stockInHand">₹0</h4></div></div>
    <div class="col-6 col-md-3"><div class="metric-box"><h5>Total Revenue</h5><h4 id="totalRevenue">₹0</h4></div></div>
    <div class="col-6 col-md-3"><div class="metric-box"><h5>Profit</h5><h4 id="totalProfit">₹0</h4></div></div>
    <div class="col-6 col-md-3"><div class="metric-box"><h5>Yearly Sales</h5><h4 id="yearlySales">₹0</h4></div></div>
  </div>
