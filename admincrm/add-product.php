...
<div id="suggestionsBox" class="border rounded bg-white shadow-sm mt-1 position-absolute w-100 d-none" style="z-index:1000;"></div>
    ...
    <div class="mb-3">
      ...
      <input type="text" name="msp" id="msp" class="form-control" readonly>
    </div>
    ...
    <div class="mb-3">
      ...
      <input type="text" name="asp" id="asp" class="form-control" readonly>
    </div>

    <!-- Display Price Margin -->
    <div class="mb-3">
      <label class="form-label">Display Price Margin (%)</label>
      <select name="displayMargin" id="displayMargin" class="form-select">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="mrp" id="mrp" class="form-control" readonly>
    </div>
